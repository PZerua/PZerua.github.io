...
// include: C:\Users\u104032\AppData\Local\Temp\tmpbbdhaq81.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'gs_renderer.data';
      var REMOTE_PACKAGE_BASE = 'gs_renderer.data';
...
Module['FS_createPath']("/data", "plys", true, true);
...
Module['FS_createPath']("/data/textures", "environments", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_gs_renderer.data');

      };
      Module['addRunDependency']('datafile_gs_renderer.data');
    ...
    loadPackage({"files": [{"filename": "/data/fonts/Lato/Lato.json", "start": 0, "end": 499571}, {"filename": "/data/fonts/Lato/Lato.png", "start": 499571, "end": 737281}, {"filename": "/data/plys/InteriorDesign.ply", "start": 737281, "end": 38283780}, {"filename": "/data/shaders/gs_basis.wgsl", "start": 38283780, "end": 38287511}, {"filename": "/data/shaders/gs_covariance.wgsl", "start": 38287511, "end": 38289682}, {"filename": "/data/shaders/gs_render.wgsl", "start": 38289682, "end": 38291648}, {"filename": "/data/shaders/gs_scan.wgsl", "start": 38291648, "end": 38297760}, {"filename": "/data/shaders/gs_scan_sum.wgsl", "start": 38297760, "end": 38300995}, {"filename": "/data/shaders/gs_shuffle.wgsl", "start": 38300995, "end": 38304408}, {"filename": "/data/textures/buttons/a.png", "start": 38304408, "end": 38325173}, {"filename": "/data/textures/buttons/b.png", "start": 38325173, "end": 38346117}, {"filename": "/data/textures/buttons/y.png", "start": 38346117, "end": 38366055}, {"filename": "/data/textures/circle_white.png", "start": 38366055, "end": 38370690}, {"filename": "/data/textures/environments/sky.hdr", "start": 38370690, "end": 43403938}, {"filename": "/data/textures/slider.png", "start": 43403938, "end": 43409007}, {"filename": "/data/textures/submenu_mark.png", "start": 43409007, "end": 43416118}], "remote_package_size": 43416118});

  })();

// end include: C:\Users\u104032\AppData\Local\Temp\tmpbbdhaq81.js
// include: C:\Users\u104032\AppData\Local\Temp\tmp3rn3wxch.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\u104032\AppData\Local\Temp\tmp3rn3wxch.js
// include: C:\Users\u104032\AppData\Local\Temp\tmpy4nu9dsw.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\u104032\AppData\Local\Temp\tmpy4nu9dsw.js
...
// end include: preamble.js
  ...
  var _emwgpuAdapterRequestDevice = (
      adapterPtr,
      futureIdL, futureIdH,
      ...
      if (descriptor) {
        ...
        var requiredLimitsPtr = HEAPU32[(((descriptor)+(20))>>2)];
  ...
  var _emwgpuDeviceCreateComputePipelineAsync = (devicePtr, futureIdL, futureIdH, descriptor) => {
      ...
      WebGPU._futureInsert(futureIdL, futureIdH, device.createComputePipelineAsync(desc).then((pipeline) => {
        ...
        _emwgpuOnDeviceCreateComputePipelineCompleted(futureIdL, futureIdH, 1, pipelinePtr, 0);
      }, (pipelineError) => {
        
        var sp = stackSave();
        var messagePtr = stringToUTF8OnStack(pipelineError.message);
        var status =
          pipeline.reason === 'validation' ? 3 :
          pipeline.reason === 'internal' ? 4 :
          7;
  ...
  var _emwgpuDeviceCreateRenderPipelineAsync = (devicePtr, futureIdL, futureIdH, descriptor) => {
      ...
      WebGPU._futureInsert(futureIdL, futureIdH, device.createRenderPipelineAsync(desc).then((pipeline) => {
        ...
        WebGPU._tableInsert(pipelinePtr, pipeline);
        _emwgpuOnDeviceCreateRenderPipelineCompleted(futureIdL, futureIdH, 1, pipelinePtr, 0);
      }, (pipelineError) => {
  ...
  var _wgpuBufferDestroy = (bufferPtr) => {
  ...
  var _wgpuDeviceDestroy = (devicePtr) => {
  ...
  function _wgpuRenderPassEncoderSetIndexBuffer(passPtr,bufferPtr,format,offset_low, offset_high,size_low, size_high) {
    var offset = convertI32PairToI53Checked(offset_low, offset_high);
  ...
  function _wgpuRenderPassEncoderSetVertexBuffer(passPtr,slot,bufferPtr,offset_low, offset_high,size_low, size_high) {
    var offset = convertI32PairToI53Checked(offset_low, offset_high);
    var size = convertI32PairToI53Checked(size_low, size_high);
  ...
  var _wgpuSurfaceConfigure = (surfacePtr, config) => {
      ...
      var viewFormats = HEAPU32[(((config)+(28))>>2)];
  ...
  var _wgpuSurfaceGetCurrentTexture = (surfacePtr, surfaceTexturePtr) => {
      ...
      try {
        ...
        HEAPU32[((surfaceTexturePtr)>>2)] = texturePtr;
...
var _emwgpuCreateComputePassEncoder = createExportWrapper('emwgpuCreateComputePassEncoder', 0);
var _emwgpuCreateComputePipeline = createExportWrapper('emwgpuCreateComputePipeline', 0);
var _emwgpuCreatePipelineLayout = createExportWrapper('emwgpuCreatePipelineLayout', 0);
var _emwgpuCreateQuerySet = createExportWrapper('emwgpuCreateQuerySet', 0);
...
var _emwgpuCreateSampler = createExportWrapper('emwgpuCreateSampler', 0);
...
var _emwgpuOnDeviceCreateComputePipelineCompleted = createExportWrapper('emwgpuOnDeviceCreateComputePipelineCompleted', 5);
var _emwgpuOnDeviceCreateRenderPipelineCompleted = createExportWrapper('emwgpuOnDeviceCreateRenderPipelineCompleted', 5);
