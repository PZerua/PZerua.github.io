...
SubFilterNode.prototype.evaluateHash = function() {
    var inputsValues = [];
...
SubFilterNode.prototype.onConnectionsChange = function() {
    if (this.heightmapOBJ) {
        this.setOutputData(0, this.heightmapOBJ);
    }
}

SubFilterNode.prototype.checkProperties = function() {
...
SubFilterNode.prototype.onExecute = function() {
    ...
    if (!this.filterTexture) {
        ...
        this.fboFilter = new FrameBuffer(this.heightmapOBJ_0.size, this.heightmapOBJ_0.size, this.filterTexture, "subFilter", setFilterUniformsCallback);
    } else {
    ...
    if (!this.filterTextureColor) {
        ...
        // Create framebuffer providing the texture and a custom shader
        this.fboFilterColor = new FrameBuffer(this.heightmapOBJ_0.size, this.heightmapOBJ_0.size, this.filterTextureColor, "subFilter", setFilterColorUniformsCallback);
    } else {
