...
XJoinFilterNode.prototype.evaluateHash = function() {
    var inputsValues = [];
...
XJoinFilterNode.prototype.onConnectionsChange = function() {
    if (this.heightmapOBJ) {
        this.setOutputData(0, this.heightmapOBJ);
    }
}

XJoinFilterNode.prototype.checkProperties = function() {
...
XJoinFilterNode.prototype.onExecute = function() {
    ...
    if (!this.filterTexture) {
        ...
        this.fboFilter = new FrameBuffer(this.heightmapOBJ_0.size, this.heightmapOBJ_0.size, this.filterTexture, "xJoinFilter", setFilterUniformsCallback);
    } else {
    ...
    if (!this.filterTextureColor) {
        ...
        // Create framebuffer providing the texture and a custom shader
        this.fboFilterColor = new FrameBuffer(this.heightmapOBJ_0.size, this.heightmapOBJ_0.size, this.filterTextureColor, "xJoinFilter", setFilterColorUniformsCallback);
    } else {
